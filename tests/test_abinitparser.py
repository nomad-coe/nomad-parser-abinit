...
def test_dos(parser):
    ...
    assert np.shape(sec_sccs[0].dos_electronic[0].dos_total[0].dos_values) == (1601,)
    assert np.shape(sec_sccs[1].dos_electronic[0].dos_total[1].dos_values) == (1601,)
    assert sec_sccs[0].dos_electronic[0].dos_energies[70].magnitude == approx(-3.18261365e-18)
    assert sec_sccs[0].dos_electronic[0].dos_total[0].dos_values[151] == approx(2.3683548842219e+16)
    assert sec_sccs[1].dos_electronic[0].dos_total[1].dos_values[180] == approx(1.0149048917891533e+17)
    assert sec_sccs[0].dos_electronic[0].dos_total[0].dos_integrated[457] == approx(346.065418538308)
    assert sec_sccs[1].dos_electronic[0].dos_total[0].dos_integrated[1025] == approx(559.5204858936601)
